...
board_width = 400
board_height = 400
field_size = board_height // 8  # Size of each chessboard square
img = {}  # Dictionary to store chess piece images
counter = 0  # Counter for animation frames
...
def draw_stalemate_message(screen):
    ...
    stalemate_text = font.render("Stalemate!", True, pygame.Color("orange"))
    screen.blit(stalemate_text, (board_width // 2 - stalemate_text.get_width() // 2, board_height // 2 - stalemate_text.get_height() // 2))
    pygame.display.flip()
