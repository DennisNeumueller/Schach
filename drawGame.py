...
move_sound = pygame.mixer.Sound("../Schach/sounds/move_sound.mp3")
beat_sound = pygame.mixer.Sound("../Schach/sounds/capture_sound.mp3")
check_sound = pygame.mixer.Sound("../Schach/sounds/check_sound.mp3")
promote_sound = pygame.mixer.Sound("../Schach/sounds/promote_sound.mp3")
funny_sound = pygame.mixer.Sound("../Schach/sounds/metal_pipe.mp3")
